...
static STORM_INLINE void storm_load_key(storm_state_t k, const unsigned char * key, const unsigned char * iv, const size_t ivlen, tag_t tag)
{
    size_t i;
    storm_word_t * K = k->S;
...
#if defined(M4)
static STORM_INLINE void storm_update_key(storm_state_t k)
{
    storm_word_t * K = k->S;
